...
var nt = /* @__PURE__ */ ((t) => (t.IDLE = "idle", t.UPLOADING = "uploading", t.COMPLETED = "completed", t.FAILED = "failed", t))(nt || {}), J;
(function(t) {
...
`);
  ...
  static wrapError(e, s, r, n) {
    ...
    if (n && typeof n == "object") {
      const l = n.statusCode, h = l === 403 && (((a = (i = (o = n.response) === null || o === void 0 ? void 0 : o.message) === null || i === void 0 ? void 0 : i.match(/code=(\d+.\d+)/)) === null || a === void 0 ? void 0 : a[1]) === "403.1" || ((d = n.response) === null || d === void 0 ? void 0 : d.type) === J.QUOTA_EXCEEDED);
...
const zt = /* @__PURE__ */ new Map([[400, { code: A.UNEXPECTED_RESPONSE, message: "Bad request" }], [401, { code: A.UNAUTHORIZED, message: "Unauthorized" }], [403, { code: A.FORBIDDEN, message: "Forbidden" }], [404, { code: A.NOT_FOUND, message: "Not found" }], [405, { code: A.METHOD_NOT_ALLOWED, message: "The user is authorized to act on this resource, but cannot use the specified method." }], [406, { code: A.NOT_ACCEPTABLE, message: "Unable to obtain resource in a content type matching the Accept header or rendition type parameter." }], [409, { code: A.ALREADY_EXISTS, message: "Already exists" }], [412, { code: A.PRECONDITION_FAILED, message: "Precondition failed" }], [501, { code: A.NOT_IMPLEMENTED, message: "Not implemented" }], [507, { code: A.EXCEEDS_QUOTA, message: "Exceeds quota" }], [509, { code: A.BANDWIDTH_LIMIT_EXCEEDED, message: "Bandwidth limit exceeded" }]]), cn = new Map(Object.entries({ [J.ASSET_MOVED]: { code: A.ASSET_MOVED, message: "Asset moved to a different region while operation was in progress" }, [J.COMPOSITE_INTEGRITY]: { code: A.INCOMPLETE_COMPOSITE, message: "Incomplete composite. invoke missingComponentsFromError with this error for more information." }, [J.PARTIAL_ASSET]: { code: A.NO_COMPOSITE, message: "Asset is partially created. No Manifest found" }, [J.LIMIT_RESOURCE_COUNT]: { code: A.UNEXPECTED_RESPONSE, message: "Resource count limit exceed" }, [J.QUOTA_EXCEEDED]: { code: A.EXCEEDS_QUOTA, message: "Quota exceeded" }, [J.ASSET_LOCKED]: { code: A.ASSET_LOCKED, message: "Asset is locked and cannot be modified" } })), Vo = (t, e) => {
  var s;
  const r = cn.get((s = t.type) !== null && s !== void 0 ? s : "") || (typeof t.status == "number" ? zt.get(t.status) : void 0);
  return r ? new c(r.code, r.message, t, e) : void 0;
}, it = (t) => {
  var e, s;
  const r = cn.get((s = (e = t.response) === null || e === void 0 ? void 0 : e.type) !== null && s !== void 0 ? s : "") || zt.get(t.statusCode);
  return r ? new c(r.code, r.message, void 0, t, t.response) : void 0;
}, qt = (t, e) => t && e ? t < 300 && t > 199 || it(e) || !1 : new c(A.NETWORK_ERROR, "Invalid or missing status code or response", void 0, e);
let Ut;
...
const Yo = (t) => C(t) && (Y(t.pipe) || Y(t.pipeTo)), C = (t) => t != null && typeof t == "object", Y = (t) => typeof t == "function", fe = (t) => Array.isArray(t), zo = (t) => C(t) && Y(t.constructor) && t.constructor.name === "ArrayBuffer" && Y(t.slice), Cr = (t) => {
...
}, qo = () => typeof self == "object" && self.self === self, Kt = () => Go(), Xt = (t) => {
...
}, Ot = 48, Zo = 49, Zt = 57, ks = 97, ws = 65, ln = 102, hn = 70, Sr = (t) => {
  const e = t.charCodeAt(0);
  return e >= Ot && e <= Zt || e >= ks && e <= ln || e >= ws && e <= hn;
}, Ht = (t) => t.length >= 3 && t.charAt(0) === "%" && Sr(t.charAt(1)) && Sr(t.charAt(2)), xt = (t) => {
  const e = t.charCodeAt(0);
  return e >= Ot && e <= Zt ? e - Ot : e >= ks && e <= ln ? 10 + e - ks : e >= ws && e <= hn ? 10 + e - ws : 0;
}, Gs = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_.~", Nr = "0123456789ABCDEF", Ys = (t) => {
  const e = [];
...
const Qo = (t, e) => {
  ...
  return r;
}, Et = (t) => (t = t.normalize("NFC"), zs(t, Jo)), gs = (t) => {
  t = t.normalize("NFC");
  let e = 0, s = "";
  for (; e < t.length; ) Ht(t.substr(e)) ? (s += t.substr(e, 3), e += 3) : s += zs(t.charAt(e++), un);
  return s;
}, Fe = (t, e) => {
    ...
    if (++s < t.length) {
      ...
      for (h = "", a = !0, d = !0; s < t.length; ) if (t.charAt(s) === "}" || t.charAt(s) === "," || t.charAt(s) === "*" || t.charAt(s) === ":") {
        ...
        if (h.length > 0 && h.charAt(h.length - 1) === "*" && (l = !0, h = h.substr(0, h.length - 1)), h.length > 0) {
          ...
          } else if (typeof I == "object" && I !== null) for (const R in I) Object.prototype.hasOwnProperty.call(I, R) && (y = R, P = String(I[R]), r += a ? p : l || d ? _ : ",", o && h && a && !l && (r += Et(h), (!i || P.length > 0) && (r += "=")), y && (r += n ? gs(y) : Et(y), r += l ? "=" : ",", P && (r += n ? gs(P) : Et(P))), a = !1, d = !1);
          else m(String(I));
        }
        if (t.charAt(s++) === "}") break;
        h = "", d = !0;
  ...
  } else Ht(t.substr(s)) ? (r += t.substr(s, 3), s += 3) : r += zs(t.charAt(s++), un);
  var y, P;
  return r;
}, Dr = (t, e) => {
...
const ri = /^([^:]+):(.*)$/, wr = /^\s+|\s+$/g, Ws = (t) => {
  ...
  return e;
}, Ce = (t, e, s) => fe(e) ? new c(c.INVALID_PARAMS, `Param '${t}' type must be one of: [${e.join(",")}].${s && s.length > 0 ? " Possible values: " + s.join(", ") + "." : ""}`) : new c(c.INVALID_PARAMS, `Param '${t}' must be of type '${e}'.${s && s.length > 0 ? " Possible values: " + s.join(", ") + "." : ""}`), ze = (t, e, s, r = !1, n = []) => {
  if (r && e == null) return !0;
  if (fe(s)) {
    for (const i in s) {
      const a = s[i];
      try {
        return ze(t, e, a, r, n), !0;
      } catch {
      }
    }
    throw Ce(t, s, n);
  ...
  if (s.endsWith("[]")) {
    ...
    return e.forEach(((i, a) => {
      ze(`${t}[${a}]`, i, s.substr(0, s.length - 2));
    })), !0;
  }
  let o = s.toLowerCase();
  switch (s) {
  ...
  parse(e, s = 0) {
    ...
    for (; i < o; ) if (n === Bt) {
      ...
      if (r[i] !== "<") throw new Error('Unexpected character "' + r[i] + '" at offset ' + i);
      {
        ...
        a = { uri: r.slice(i + 1, d) }, this.refs.push(a), i = d, n = Lr;
      }
      i++;
    } else if (n === Lr) {
      if ($t(r[i])) {
      ...
      if (n !== Is) throw new Error('Unknown parser state "' + n + '"');
      {
        ...
        const l = Mr(r.slice(i, d)).toLowerCase();
        let h = "";
        if (i = d + 1, i = ui(r, i), r[i] === '"') for (i++; i < o; ) {
          ...
          let p = i + 1;
          for (; !li.test(r[p]) && p < o; ) p++;
          h = r.slice(i, p), i = p;
        }
        if (!(a && a[l] && _i(l))) if (a && l[l.length - 1] === "*") a[l] = fi(h);
...
const gi = () => {
  if (jt) return jt;
  const t = Wt();
  return jt = t && C(globalThis.performance) && Y(globalThis.performance.now) ? globalThis.performance : t && C(globalThis.perf_hooks) && C(globalThis.perf_hooks.performance) && Y(globalThis.perf_hooks.performance.now) ? globalThis.perf_hooks.performance : qo() && C(self.performance) && Y(self.performance.now) ? self.performance : Date, jt;
}, ae = () => gi().now(), Ii = (t) => Ls(void 0, void 0, void 0, (function* () {
  return new Promise(((e) => setTimeout(e, t)));
}));
function gn(t, e, s, r, n) {
  return Ls(this, void 0, void 0, (function* () {
    return t().catch(((o) => Ls(this, void 0, void 0, (function* () {
      var i, a, d;
      ...
      if (((d = o.response) === null || d === void 0 ? void 0 : d.statusCode) === e && o.response.response.type === r) return yield Ii(l), gn(t, e, s, r);
      throw o;
    }))));
  }));
}
...
const Ti = { [q.Deprecated]: "error", [q.Error]: "error", [q.Log]: "log", [q.Warn]: "warn", [q.Debug]: "debug" };
class ue extends qs {
  constructor(e) {
    super([Ne.CreateComposite, Ne.UploadComponent, Ne.PushComposite, Ne.PullComposite, Ne.PullCompositeVersion, Ne.DownloadComponent]), this._logLevel = q.Warn, this._prevDebugTime = ae(), this._debugFormatter = (s, r, n, o) => `[${s} (+${(1e3 * (r - n)).toFixed(0)})] ${o.map(((i) => typeof i == "string" ? i : JSON.stringify(i))).join(" ")}`, this._debugNamespaces = [], this._debugSkips = [], this.suppressDeprecationWarnings = !1, e && (this._logCallback = e), this._initNamespaces();
  }
  get debugNamespaces() {
  ...
  _initNamespaces() {
    Wt() ? this.setDebugNamespaces(process.env.DCX_DEBUG || "") : C(globalThis) && C(globalThis.dcxjs) && this.setDebugNamespaces(globalThis.dcxjs.debug || ""), this._debugNamespaces.length > 0 && (this._logLevel = q.Debug);
  }
  _log(e, s, r) {
    try {
...
ue.LEVEL_DEBUG = q.Debug, ue.LEVEL_LOG = q.Log, ue.LEVEL_WARN = q.Warn, ue.LEVEL_ERROR = q.Error, ue.LEVEL_DEPRECATED = q.Deprecated;
const Xs = () => {
  const t = In();
...
const S = Ai;
var mi = typeof globalThis == "object" ? globalThis : typeof self == "object" ? self : typeof window == "object" ? window : typeof globalThis == "object" ? globalThis : {}, Ze = "1.9.0", $r = /^(\d+)\.(\d+)\.(\d+)(-(.+))?$/;
function yi(t) {
...
), zi = new Bi(), qi = new ji(), Wi = new Fi(), Ki = new Hi(), Xi = new Vi(), Zi = new $i(), Ji = new Gi(), Qi = new Yi(), ea = {
  get: function(t, e) {
    if (t != null)
      return t[e];
  },
  ...
  (function() {
    ...
    return t.prototype.startSpan = function(e, s, r) {
      ...
      if (!(arguments.length < 2)) {
        ...
        var d = i ?? As.active(), l = this.startSpan(e, o, d), h = er(d, l);
        return As.with(h, a, void 0, l);
      }
    }, t;
  })()
);
...
var ys = "propagation", ka = new Ca(), wa = (
  /** @class */
  (function() {
    function t() {
...
), La = wa.getInstance(), vs = "trace", Ma = (
  /** @class */
  (function() {
    function t() {
      this._proxyTracerProvider = new Gr(), this.wrapSpanContext = Ea, this.isSpanContextValid = vn, this.deleteSpan = la, this.getSpan = Qs, this.getActiveSpan = da, this.getSpanContext = yn, this.setSpan = er, this.setSpanContext = ha;
    }
    return t.getInstance = function() {
      return this._instance || (this._instance = new t()), this._instance;
      ...
      Dt(vs, ke.instance()), this._proxyTracerProvider = new Gr();
    }, t;
  })()
), Ua = Ma.getInstance();
const At = {
...
const Ga = "application/vnd.adobecloud.directory+json", Ya = "application/vnd.adobe.dcx-manifest+json", za = "application/json", Bs = "application/problem+json", ht = "application/json-patch+json", Sn = "application/vnd.adobecloud.bulk-transfer+json", qa = "application/vnd.adobe.asset-operation+json", nr = ["buffer", "arraybuffer", "string", "text", "blob", "json", "stream", "defaultbuffer"];
function Nn(t, e) {
  var s = {};
...
const k = (t, e, s) => {
  ...
  return (i, a) => {
    ...
    const h = n[i] || ((d = zt.get(i)) === null || d === void 0 ? void 0 : d.message) || "Unexpected response", p = r[i] || ((l = zt.get(i)) === null || l === void 0 ? void 0 : l.code), _ = qt(i, a);
  ...
  return !0;
}, Ka = (t, e = []) => !!C(t) && lt(t.links || t._links, e);
function wn(t) {
...
function se(t, e) {
  ...
  return s.embedded = Object.entries({ EffectivePrivileges: u.EFFECTIVE_PRIVILAGES, RepositoryResource: u.REPOSITORY, AppMetadata: u.APP_METADATA }).reduce(((n, [o, i]) => (r.filter(((a) => a && i in a)).forEach(((a) => de(n, { [o]: i === u.REPOSITORY ? ir(a) : a }))), n)), {}), w(s);
}
function ir(t = {}) {
...
function xn(t, e) {
  ...
  return or(s, qe("/", s), e).then(((n) => le(n))).then(((n) => (r && r.setIndexLinks(n), n))).catch(((n) => {
...
function ar(t) {
  try {
    ...
    for (const r in e.refs) {
      const n = e.refs[r], { rel: o, uri: i, templated: a, type: d, width: l, height: h } = n, p = Nn(n, ["rel", "uri", "templated", "type", "width", "height"]), _ = w({ href: i, templated: a ? a === "true" : void 0, type: d, width: l, height: h, [j.MAX_SINGLE_TRANSFER_SIZE]: p[j.MAX_SINGLE_TRANSFER_SIZE.toLowerCase()], [j.REPO_MIN_BLOCK_TRANSFER_SIZE]: p[j.REPO_MIN_BLOCK_TRANSFER_SIZE.toLowerCase()] });
...
function jn(t, e, s, r, n, o, i, a) {
  Re("copyAsset()"), E(["svc", t, "object"], ["srcAsset", e, "object"], ["destAsset", s, "object"], ["createIntermediates", r, "boolean"], ["overwriteExisting", n, "boolean", !0], ["manifestPatch", i, ["object", "string"], !0]), we(e, ["repo:path", "path", "assetId", "repo:assetId"], "string"), we(s, ["repo:path", "path", "assetId", "repo:assetId"], "string");
  const d = Ae("copy", s, e, { overwriteExisting: n, createIntermediates: r }, w({ "repo:manifestPatch": JSON.stringify(i), nameConflictPolicy: a })), l = x(t);
  return Le.call(this, t).then(((h) => Ve(l, h, d, o))).then(os.bind(void 0, s)).then(cr);
}
function Vn(t, e, s, r, n, o, i) {
  Re("moveAsset()"), E(["svc", t, "object"], ["srcAsset", e, "object"], ["destAsset", s, "object"], ["createIntermediates", r, "boolean"], ["overwriteExisting", n, "boolean", !0]), we(e, ["repo:path", "path", "assetId", "repo:assetId"], "string"), we(s, ["repo:path", "path", "assetId", "repo:assetId"], "string");
  const a = Ae("move", s, e, { createIntermediates: r, overwriteExisting: n }, w({ nameConflictPolicy: i })), d = x(t);
  return Le.call(this, t).then(((l) => Ve(d, l, a, o))).then(os.bind(void 0, s)).then(cr);
}
function Fn(t, e, s, r, n) {
  Re("discardAsset()"), E(["svc", t, "object"], ["asset", e, "object"], ["etag", s, "string", !0], ["recursive", r, "boolean", !0]);
  const o = x(t);
  we(e, ["repo:path", "path", "assetId", "repo:assetId"], "string");
  const i = Ae("discard", Object.assign(Object.assign({}, e), { etag: s }), void 0, { recursive: r });
  return Le.call(this, t).then(((a) => Ve(o, a, i, n))).then(es);
}
const Hn = ns("AdobeDCX.deleteAsset", (function(t, e, s = "*", r, n) {
  ...
  const o = x(t);
  if (e.format === Ga && r == null) throw new c(c.INVALID_PARAMS, "Recursive flag is required for directory assets.");
  if (!r && Ka(e, [u.REPO_METADATA])) {
    const d = X(e, u.REPO_METADATA, {});
  ...
  return Le.call(this, t).then(((d) => Ve(o, d, a, n))).then(es);
}));
function $n(t, e, s, r) {
  Re("restoreAsset()"), E(["svc", t, "object"], ["asset", e, "object"]);
  const n = x(t);
  we(e, ["assetId", "repo:assetId"], "string");
  const o = Ae("restore", e, void 0, void 0, { nameConflictPolicy: r });
  return Le.call(this, t).then(((i) => Ve(n, i, o, s))).then(os.bind(void 0, e)).then(cr);
}
function Gn(t, e, s, r, n, o) {
  var i, a;
  Re("packageAssets()"), E(["svc", t, "object"], ["destination", s, "object"]), ze("sources", e, ["object", "object[]"]), e = fe(e) ? e : [e], i = ["repo:path", "path", "assetId", "repo:assetId"], a = "string", e.map(((h) => we(h, i, a))), we(s, ["repo:path", "path", "assetId", "repo:assetId"], "string");
  const d = Ae("package", s, e, { createIntermediates: r, overwriteExisting: n }), l = x(t);
  return Le.call(this, t).then(((h) => Ve(l, h, d, o))).then(os.bind(void 0, s)).then(es);
}
function Qa(t, e, s, r) {
...
class sc {
  ...
  copyResources(e, s, r, n, o, i) {
    ...
    const a = this._docs.find(/* @__PURE__ */ (function(l, h) {
      return function(p) {
        return p.op === "copy_resources" && Jr(p.source, l) && Jr(p.target, h);
      };
    })(e, s));
  ...
  restore(e, s) {
    Ke("restore()"), this._assertUnderLimit(), we(e, ["assetId", "repo:assetId"], "string"), this._checkTargetType(e);
...
function Yn(t, e, s, r = {}, n = !1) {
  return t.invoke(v.POST, e, Object.assign({ [b.CONTENT_TYPE]: qa }, r), typeof s == "string" ? s : JSON.stringify(s), { isStatusValid: k(), responseType: "json", retryOptions: { pollCodes: [202], pollHeader: "location", pollMethod: "get", modifyHeadersCallback: Cn([b.PREFER]), skipPollingTimeout: n } });
}
function os(t, e) {
...
function zn(t, e, s, r, n, o, i) {
  ...
  return (function(a, d, l, h, p, _, f, m) {
    ...
    const y = [];
    for (let D = 0; D < h.length; D += p) y.push(h.slice(D, D + p));
    let P;
    function I(D, O) {
      const N = Zr().copyResources(d, l, O, _, f).getDocument();
      return Le(a).then(((M) => Ve(x(a), M, N, m, !0))).then(((M) => {
        P ? P.response[0].resources.push(...M.response[0].resources) : P = M;
        const { asset: Q, source: Z, target: he, resources: be } = M.response[0], Oe = { source: se(Z), target: se(he), resources: be, asset: Q ? se(Q) : void 0 };
...
}(), G = B("dcx:assets:blockdownload"), rc = B("dcx:assets:blockdownload:leaf"), nc = (function* () {
  let t = 0;
  for (; ; ) yield t++;
})();
class oc extends qs {
  constructor(e, s, r = {}) {
    ...
    const { startByte: n, blockSize: o, endByte: i, url: a, totalSize: d, maxConcurrentRequests: l } = Object.assign({ blockSize: ce.downloadChunkSize, maxConcurrentRequests: 4 }, w(r));
    E(["svc", e, "object"], ["responseType", s, "enum", !1, ["buffer"]], ["blockSize", o, "+number"], ["url", a, "string", !0], ["startByte", n, "number", !0], ["endByte", i, "number", !0], ["totalSize", d, "number", !0], ["maxConcurrentRequests", l, "+number"]), this._dbgId = nc.next().value, this._maxConcurrentRequests = l, this._blockSize = Math.round(o), this._service = e, this._url = a, this._startByte = n, this._endByte = i, this._totalSize = d, this._bytes = new Uint8Array(), this._promise = new S(((h, p) => {
      this._resolve = () => {
        G(this._dbgId, "resolving"), this.removeAllHandlers(), h(this);
      }, this._reject = (_) => {
  ...
  _handleError(e) {
    G(this._dbgId, "_handleError(): ", e), this._shiftState(g.ERROR), this._error = e, dt(e) || (this._error = new c(c.UNEXPECTED, "An unexpected error occurred.", e)), this._reject(this._error);
  }
...
function et(t, e, s, r, n = "defaultbuffer", o, i, a) {
  ...
  let l = S.resolve(e, this !== void 0 ? this : {});
  return o || (l = l.then((() => t.invoke(v.GET, e, Object.assign({ priority: "u=1" }, a), void 0, { responseType: "text", isStatusValid: k(), retryOptions: { pollCodes: [202], pollHeader: "location", pollMethod: "GET" } }))).then(((h) => {
    const p = h.response.indexOf("href") > 0 ? Dr(h.response, '"href":\\s*"([^;"]*)"') : "";
    if (typeof p != "string" || p === "") throw new c(c.UNEXPECTED_RESPONSE, "No block download href found in response.", void 0, h);
    return i = i || parseInt(Dr(h.response, '"size":\\s*(\\d+)')), p;
  }))), l.then(((h) => ne(this, void 0, void 0, (function* () {
    return d ? Promise.race([d.init(h, i).then((() => ce.addAndStartDownload(d))), d.promise]).then((() => ({ statusCode: 200, headers: w({ [b.CONTENT_TYPE]: d.contentType, [b.CONTENT_LENGTH]: d.totalSize }), responseType: n, response: ac(d.buffer, n, d.contentType), message: "OK" }))) : t.invoke(v.GET, h, qn(s, r), void 0, { responseType: "stream", isExternalRequest: !0 });
  }))));
}
function ac(t, e, s) {
...
const Gt = B("dcx:assets:private");
function dr(t, e, s, r, n = "defaultbuffer", o, i, a = {}, d = !1) {
  let l;
  Gt("_getUrlFallbackDirect()");
  const h = this !== void 0 ? this : {};
  return S.resolve(void 0, h).then((() => t.invoke(v.GET, s, Object.assign({ priority: "u=1" }, a), void 0, { responseType: n, isStatusValid: k([400]) }))).then(((p) => (Gt("_gUFD() status code", p.statusCode), l = p, p.statusCode === 400 && p.xhr ? p.xhr.getResponseDataAsJSON() : p))).then(((p) => {
    const _ = C(p) && (l.statusCode === 400 || p.status === 400) && p.type === J.RESPONSE_TOO_LARGE;
    if (Gt("_gUFD() do direct", _), !_ && l.statusCode === 400) throw new c(c.UNEXPECTED_RESPONSE, "Unexpected response", void 0, l);
    return _;
  })).then(((p) => {
    if (!p) return l;
    if (!("location" in l.headers) || typeof l.headers.location != "string" || "location" in l.headers && l.headers.location.includes("platform")) {
      ...
      const _ = w({ reltype: r, component_id: o, revision: i }), f = X(e.links, u.BLOCK_DOWNLOAD, { resource: r ? JSON.stringify(_) : void 0 });
      return d ? { statusCode: 200, headers: w({ [b.CONTENT_TYPE]: l.headers["content-type"], [b.CONTENT_LENGTH]: l.headers["content-length"] }), responseType: n, response: { href: f }, message: "OK" } : et.call(h, t, f, void 0, void 0, n, !1, void 0, a);
    }
    return d ? { statusCode: 200, headers: w({ [b.CONTENT_TYPE]: l.headers["content-type"], [b.CONTENT_LENGTH]: l.headers["content-length"] }), responseType: n, response: { href: l.headers.location }, message: "OK" } : et.call(h, t, l.headers.location, void 0, void 0, n, !0, void 0, a);
  }));
}
function Yt({ additionalHeaders: t = {}, asset: e, contentType: s, data: r, etag: n, headHref: o, href: i, maybeIsNew: a, relation: d, service: l }, h = !1) {
  if (Gt("_doUpload()"), E(["service", l, "object"], ["asset", e, "object"], ["href", i, "string"], ["headHref", o, "string"], ["contentType", s, "string", !0], ["maybeIsNew", a, "boolean", !0], ["etag", n, "string", !0], ["isRetry", h, "boolean", !0], ["additionalHeaders", t, "object", !0]), a == null) return l.invoke(v.HEAD, o, t, void 0, { isStatusValid: k([404]) }).then(((_) => {
  ...
  const p = a;
  return p ? delete t[b.IF_MATCH] : t[b.IF_MATCH] = n || "*", s && (t[b.CONTENT_TYPE] = s), l.invoke(v.PUT, i, t, r, { isStatusValid: k([404, 409, 412]), retryOptions: { pollHeader: "location", pollCodes: [202] } }).then(((_) => {
...
function lc(t) {
  ...
  if (zo(t)) return new Uint8Array(t);
  if (Pn(t)) return t;
...
function lr(t, e) {
  ...
  const r = s.split("=")[1], n = (function(o, i) {
    ...
    return Wn(a, js(a, d), d.byteLength).map(((h) => is(h, !0)));
  })(t.response, r);
...
`, 1)[0].split(" ")[1]), l = parseInt(i["content-length"], 10);
  let h;
  return h = isNaN(l) ? (a == null ? void 0 : a.length) === 0 ? new Uint8Array([]) : a : l === 0 ? new Uint8Array([]) : a == null ? void 0 : a.subarray(0, l), { headers: i, response: i[b.CONTENT_TYPE] === Bs && h !== void 0 ? JSON.parse(ve(h)) : h, statusCode: d };
}
function hc(t) {
...
function as(t, e, s, r = "id", n = {}, o = !1) {
  return cc("performBulkRequest()"), E(["svc", t, "object"], ["asset", e, "object"], ["requests", s, "array"], ["linkMode", r, "string", !0, ["id", "path"]]), V(e.links, [u.BULK_REQUEST]), hc(s), Kn(t, e, s, r, n).then((({ response: i, subresponses: a }) => ne(this, void 0, void 0, (function* () {
    const d = Xn(a, s);
...
function Kn(t, e, s, r = "id", n = {}) {
  ...
  return t.invoke(v.POST, d, a, i, { isStatusValid: k(), responseType: "defaultbuffer", retryOptions: { pollHeader: "location", pollCodes: [202], pollMethod: v.GET } }).then(((l) => ({ response: l, subresponses: lr(l, s.length) })));
}
function Xn(t, e) {
...
function Zn(t, e, s, r = "id", n = {}, o, i = 5) {
  return ne(this, void 0, void 0, (function* () {
    ...
    if (s.length === 1) {
      const [d] = s, l = yield x(t).invoke(d.method, d.href, d.headers, d.body, { isStatusValid: k(), responseType: "defaultbuffer", retryOptions: { pollHeader: "location", pollCodes: [202], pollMethod: v.GET } });
    ...
    const a = yield Kn(t, e, s, r, n).then(((d) => ne(this, void 0, void 0, (function* () {
      const l = Xn(d.subresponses, s);
      return l.length ? yield Zn(t, e, l, r, n, d.subresponses, i - 1) : d.subresponses;
    }))));
    return o.map(((d) => a.find(((l) => l.headers["content-id"] === d.headers["content-id"])) || d));
  }));
}
const F = B("dcx:assets:asset"), $ = B("dcx:assets:asset:leaf");
class bt {
  constructor(e, s, r = {}) {
  ...
  getLinkHrefTemplated(e, s, r = "id") {
    return F("getLinkHrefTemplated()"), X({ _links: this._links }, e, s, r);
  }
  getLinkHref(e, s = "id") {
  ...
  getACLPolicy(e) {
    return F("getACLPolicy()"), this.fetchLinksIfMissing([u.ACL_POLICY], e).then((() => lo(this._svc, this)));
  }
  checkACLPrivilege(e, s, r) {
    return F("checkACLPrivilege()"), E(["privilege", e, "string"], ["relation", s, "string"]), this.fetchLinksIfMissing([u.ACCESS_CHECK], r).then((() => ho(this._svc, this, e, s)));
  }
  ...
  copyResources(e, s, r, n, o) {
    return F("copyResources()"), E(["targetAsset", e, "object"], ["resources", s, "array"], ["manifestPatch", n, ["object", "string"], !0], ["intermediates", r, "boolean", !0]), zn(this.serviceConfig, { repositoryId: this.repositoryId, assetId: this.assetId, path: this.path, version: this.version }, e, s, r, n, o);
  }
  move(e, s, r, n, o) {
    return F("move()"), E(["destination", e, ["object", "string"]], ["createIntermediates", s, "boolean"], ["overwriteExisting", r, "boolean"]), Vn(this.serviceConfig, { repositoryId: this.repositoryId, assetId: this.assetId, path: this.path }, e, s, r, n, o).then((({ response: i, result: a }) => (this._data = Object.assign(Object.assign({}, this._data), w(a)), { response: i, result: this })));
  }
  delete(e, s = !1, r) {
  ...
  package(e, s, r, n) {
    return F("package()"), E(["destination", e, ["object", "string"]], ["createIntermediates", s, "boolean"], ["overwriteExisting", r, "boolean"]), Gn(this._svc, { repositoryId: this.repositoryId, assetId: this.assetId, path: this.path }, e, s, r, n);
  }
  restore(e, s) {
    return F("restore()"), $n(this._svc, { repositoryId: this.repositoryId, assetId: this.assetId }, e, s).then((({ response: r, result: n }) => (this._data = Object.assign(Object.assign(Object.assign({}, this._data), w(n)), { state: "ACTIVE" }), { response: r, result: this })));
  }
...
function _c(t, e, s = "id", r, n) {
  $("getResolveLinkForAsset()"), E(["svc", t, "object"], ["asset", e, "object"], ["mode", s, "enum", !1, ["id", "path"]], ["resource", r, ["string", "object"], !0]), wn(e);
  const o = { repositoryId: e.repositoryId, id: e.assetId, path: e.path, mode: s, resource: C(r) ? JSON.stringify(r) : r }, i = x(t), a = qe(e.assetId ? uc : pc, i);
  return S.resolve(Fe(a, w(o)));
}
...
function hr(t, e, s = "id", r, n, o) {
  $("resolveAsset()"), E(["svc", t, "object"], ["asset", e, "object"], ["mode", s, "enum", !0, ["id", "path"]], ["resource", r, ["string", "object"], !0]), wn(e);
  const i = x(t), a = oe(t), d = a && e.assetId && e.repositoryId && s === "id";
  return d && ($("rA() set pending"), a.setPending(e.assetId, e.repositoryId)), _c(t, e, s, r).then(((l) => r == null ? or(i, l, o) : Za(i, l, o, n))).then(((l) => ({ response: l, result: go(e, l, s === "id", a) }))).catch(((l) => {
    throw d && a.deleteWithAsset(e), l;
  }));
}
function gc(t, e, s) {
  return $("fetchLinksForAsset()"), eo(t, e, s).then(((r) => r.result.links));
}
function eo(t, e, s) {
  if ($("fetchAsset()"), E(["svc", t, "object"], ["asset", e, "object"]), sr(e)) return hr(t, e, "id", void 0, void 0, s).then(((a) => a));
  let r;
  try {
...
function to(t, e, s) {
  $("getLinksForAsset()"), E(["svc", t, "object"], ["asset", e, "object"]);
...
function Ic(t, e, s) {
  $("getRepoMetadata()"), E(["svc", t, "object"], ["asset", e, "object"]), V(e.links, [u.REPO_METADATA]);
...
function so(t, e, s) {
  $("updateRepoMetadata()"), E(["svc", t, "object"], ["asset", e, "object"]), V(e.links, [u.REPO_METADATA]);
  const r = H(e.links, u.REPO_METADATA), n = Object.assign({ [b.CONTENT_TYPE]: ht }, s), o = Ja(e);
  return t.invoke(v.PATCH, r, n, JSON.stringify(o), { responseType: "json", isStatusValid: k() }).then(((i) => ({ result: i.response, response: i })));
}
function Tc(t, e) {
  throw $("getBaseDirectoryMetadata()"), new c(c.NOT_IMPLEMENTED, "Method not implemented.");
}
function ro(t, e, s) {
  $("getRepositoryResource()"), E(["svc", t, "object"], ["asset", e, "object"]), V(e.links, [u.REPOSITORY]);
...
function oo(t, e, s, r = {}) {
  $("getAppMetadata()"), E(["svc", t, "object"], ["asset", e, "object"], ["etag", s, "string", !0]);
...
function io(t, e, s, r, n = {}) {
  $("putAppMetadata()"), E(["svc", t, "object"], ["asset", e, "object"], ["metadata", s, ["object", "string"]], ["etag", r, "string", !0]), V(e.links, [u.APP_METADATA]);
  const o = H(e.links, u.APP_METADATA);
  return t.invoke(v.PUT, o, w(Object.assign(n, { [b.IF_MATCH]: r, [b.CONTENT_TYPE]: za })), typeof s == "string" ? s : JSON.stringify(s), { isStatusValid: k() }).then(((i) => ({ response: i, result: { etag: i.headers.etag } })));
}
function ao(t, e, s, r, n = {}) {
  $("patchAppMetadata()"), E(["svc", t, "object"], ["asset", e, "object"], ["metadata", s, ["object[]", "string"]], ["etag", r, "string"]), V(e.links, [u.APP_METADATA]);
  const o = H(e.links, u.APP_METADATA);
  return t.invoke(v.PATCH, o, w(Object.assign(n, { [b.IF_MATCH]: r, [b.CONTENT_TYPE]: ht })), typeof s == "string" ? s : JSON.stringify(s), { isStatusValid: k() }).then(((i) => ({ response: i, result: { etag: i.headers.etag } })));
}
function co(t, e, s) {
  $("getEffectivePrivileges()"), E(["svc", t, "object"], ["asset", e, "object"]), V(e.links, [u.EFFECTIVE_PRIVILAGES]);
  const r = H(e.links, u.EFFECTIVE_PRIVILAGES);
  return t.invoke(v.GET, r, s, void 0, { responseType: "json", isStatusValid: k() }).then(((n) => ({ result: n.response, response: n })));
}
function lo(t, e, s) {
  $("getACLPolicy()"), E(["svc", t, "object"], ["asset", e, "object"]), V(e.links, [u.ACL_POLICY]);
  const r = H(e.links, u.ACL_POLICY);
  return t.invoke(v.GET, r, s, void 0, { responseType: "json", isStatusValid: k() }).then(((n) => ({ result: n.response, response: n })));
}
function ho(t, e, s, r, n = {}) {
  $("checkACLPrivilege()"), E(["svc", t, "object"], ["asset", e, "object"], ["privilege", s, "string", !1, ["ack", "read", "write", "delete"]]), V(e.links, [u.ACCESS_CHECK]);
  const o = X(e.links, u.ACCESS_CHECK, { privilege: s.toString(), relation: r });
...
function uo(t, e, s, r, n = {}) {
  $("patchACLPolicy()"), E(["svc", t, "object"], ["asset", e, "object"], ["policy", s, ["string", "object"]], ["etag", r, "string", !0]), V(e.links, [u.ACL_POLICY]);
  const o = w(Object.assign(n, { [b.CONTENT_TYPE]: ht, [b.IF_MATCH]: r })), i = H(e.links, u.ACL_POLICY);
...
function po(t, e, s = {}) {
  $("deleteACLPolicy()"), E(["svc", t, "object"], ["asset", e, "object"]), V(e.links, [u.ACL_POLICY]);
  const r = H(e.links, u.ACL_POLICY);
...
function _o(t, e, s, r, n) {
  $("useLinkOrResolveResource()"), E(["svc", t, "object"], ["asset", e, "object"], ["resource", s, "string"]);
  const o = x(t);
  let i;
  try {
    i = H(e.links, s);
  ...
  return S.resolve(i).then(((a) => {
    if (typeof a == "string") return $("uLORR() asset has link"), a;
    const d = oe(t);
    return Eo(e, d, [s]);
  })).then(((a) => {
    ...
    if (typeof a == "string") return $("uLORR() cache or asset had link"), o.invoke(v.GET, a, n, void 0, { isStatusValid: k(), responseType: r });
    if (!sr(e)) throw new c(c.INVALID_PARAMS, "Asset is not resolvable. Must contain repository ID + path/id or links.");
    return hr(t, e, "id", s, r, n);
...
function yc(t, e, s) {
  const r = (function(n, o) {
    $("getLinksAPIUrlForAsset()"), E(["svc", n, "object"], ["asset", o, "object"]);
    const i = x(n), a = qe(mc, i), { assetId: d, repositoryId: l, contentRegion: h } = o, p = w({ assetId: d, repositoryId: l, contentRegion: h });
    return Fe(a, p);
  })(t, e);
...
function fo(t, e, s = [], r = !1, n) {
  if ($("fetchLinksIfMissing()", s), E(["svc", t, "object"], ["asset", e, "object"], ["linksToPopulate", s, "string[]"], ["suppressMissingErrors", r, "boolean", !0]), lt(e.links, s)) return $("fLIM() links exist"), S.resolve({ result: e.links });
  const o = oe(t);
  return Eo(e, o, s, !0).then(((i) => i || ((function(a, d) {
    return typeof a.assetId == "string" && a.assetId.length > 0 && d.every(((l) => !Ac.has(l)));
  })(e, s) ? yc(t, e, n) : ($("fLIM() fetching links"), eo(t, e, n))))).then(((i) => {
    let a, d, l = i;
    if (On(i) && (a = i.response, l = i.result.links, d = i.result), e.links !== l) {
      e.links = de(e.links || {}, l);
      const h = oe(t);
      h && h.setValueWithAsset(e.links, e);
    }
    if (!r && !lt(l, s)) throw new c(c.INVALID_PARAMS, "Required links could not be fetched for asset.", void 0, a, w({ required: s, asset: d }));
    return $("fLIM() fetchedOCached exists"), { result: l || e.links, response: a };
  }));
}
function Eo(t, e, s, r) {
  if ($("getLinksFromCache()"), !e) return S.resolve(void 0);
  const n = e.getValueWithAsset(t);
  return n == null ? (r && e.setPending(t.assetId, t.repositoryId), S.resolve(void 0)) : S.resolve(n).then(((o) => s ? lt(o, s) ? o : void (r && e.setPending(t.assetId, t.repositoryId)) : o));
}
function vc(t, e, s, r, n, o, i) {
  return zn(t, e, s, r, n, o, i);
}
function go(t, e, s, r) {
  const n = le(e), o = Object.assign(Object.assign(Object.assign({}, (function(i) {
    return C(i.asset) ? i.asset : i;
  })(t)), w({ assetId: e.headers["asset-id"] || e.headers["x-resource-id"], format: e.headers[b.CONTENT_TYPE], md5: e.headers["content-md5"], etag: e.headers.etag, version: e.headers.version, repositoryId: e.headers["repository-id"] })), { links: n });
...
const L = B("dcx:assets:blockupload"), Sc = B("dcx:assets:blockupload:leaf");
class Nc extends qs {
  constructor(e, s, r, n, o, i, a, d, l, h, p, _, f, m, y) {
    super(["stateChanged"]), this._internalBlockUploadId = Kt(), this._state = g.NOT_INITIALIZED, this._currentBlockIndex = 0, this._pendingBlockRequests = /* @__PURE__ */ new Map(), this._bytesUploaded = 0, this._indeterminateTransfer = !1, this._maxConcurrentRequests = 4, this._retryQueue = /* @__PURE__ */ new Set(), this._activeBlockIndex = 0, this._lastExtendTime = 0, this._uploadedBlocksURLs = [], this._service = e, this._getSliceCallback = s, $a(r) ? (E([j.REPO_SIZE, r[j.REPO_SIZE], "number"]), this._blockTransferDocument = r, this._transferBlockLinks = this._blockTransferDocument[T.LINKS][u.BLOCK_TRANSFER], this._dataSize = this._blockTransferDocument[j.REPO_SIZE], this._relationType = this._blockTransferDocument[j.REPO_REL_TYPE], this._shiftState(g.INITIALIZED), L(`BlockUpload Initialized: Transfer document found with ${this._transferBlockLinks.length} links. BlockUploadId: ${this._internalBlockUploadId}`)) : (E(["relationType", n, "string"], ["dataSize", o, "number"], ["contentType", i, "string"], ["componentId", a, "string", !0], ["etag", l, "string", !0]), this._asset = r, V(this._asset.links, [u.BLOCK_UPLOAD_INIT], c.UNEXPECTED, "/rel/block/init missing from BlockTransferDocument."), this._relationType = n, this._dataSize = o, this._contentType = i, this._componentId = a, this._md5 = d, this._ifMatch = l), this._relPath = h, this._createIntermediates = p, this._respondWith = _, this._repoMetaPatch = f, this._maxConcurrentRequests = m || 4, this._nameConflictPolicy = y, this._promise = new S(((P, I) => {
  ...
  init(e) {
    if (this._assertStateIsValid("init"), !this._blockTransferDocument || !this._blockTransferDocument[T.LINKS]) {
      ...
      const s = w(Object.assign({ [j.REPO_REL_TYPE]: this._relationType, [j.REPO_IF_MATCH]: this._ifMatch, [j.REPO_SIZE]: this._dataSize, [j.DC_FORMAT]: this._contentType, [j.COMPONENT_ID]: this._componentId, [j.REPO_MD5]: this._md5 }, this._blockTransferDocument));
      return pr(this._service, this._asset, s, e).then(((r) => (this._blockTransferDocument = r.result, this._transferBlockLinks = this._blockTransferDocument[T.LINKS][u.BLOCK_TRANSFER], this._shiftState(g.INITIALIZED), L(`BlockUpload Initialized: Transfer document found with ${this._transferBlockLinks.length} links. BlockUploadId: ${this._internalBlockUploadId}`), this)));
    }
  ...
  pause() {
    return this._assertStateIsValid("pause"), this._shiftState(g.PAUSING), S.allSettled([...this._pendingBlockRequests.values()]).then((() => (this._shiftState(g.PAUSED), L(`BlockUploading has been paused.  BlockUploadId: ${this._internalBlockUploadId}`), this)));
  }
  resume() {
  ...
  _extend(e = !0) {
    ...
    const s = this._blockTransferDocument[j.REPO_SIZE], r = e ? Math.ceil(1.5 * s) : s, n = X(this._blockTransferDocument[T.LINKS], u.BLOCK_EXTEND, { size: r });
    return this._service.invoke(v.POST, n, {}, void 0, { isStatusValid: k(), responseType: "json" }).then(((o) => (this._indeterminateTransfer = !0, this._blockTransferDocument = o.response, this._transferBlockLinks = this._blockTransferDocument[T.LINKS][u.BLOCK_TRANSFER], L(`Transfer document extended (${e ? "size increased" : "URL refresh only"}): ${this._transferBlockLinks.length} transfer links. BlockUploadId: ${this._internalBlockUploadId}`), o))).catch(((o) => {
      throw dt(o) && o.problemType === J.ASSET_MOVED && this._handleAssetMoved(o), new c(c.UNEXPECTED_RESPONSE, "An unexpected error occurred while extending the block transfer document.", o, o.response);
    }));
  }
  _maybeExtendWithPauseResume() {
    if (this._extendPromise) return L("Reusing in-progress extend (with pause/resume)"), S.reject(g.PAUSED);
    L("[_maybeExtendWithPauseResume] Setting state to PAUSED and triggering extend"), this._shiftState(g.PAUSED);
    const e = S.resolve().then((() => (L("[_maybeExtendWithPauseResume] Pause done, calling _extend()"), this._extend(!1)))).then(((s) => (this._lastExtendTime = Date.now(), L("[_maybeExtendWithPauseResume] Extend done, calling resume()"), S.resolve(this.resume()).then((() => (L("[_maybeExtendWithPauseResume] Resume done"), s))))));
    return this._extendPromise = e.finally((() => {
      this._extendPromise = void 0;
    })), S.reject(g.PAUSED);
  }
  _maybePauseForRetry() {
    return this._state === g.PAUSED || this._state === g.PAUSING ? (L("[_maybePauseForRetry] Already in PAUSED or PAUSING state — skipping."), S.resolve()) : (L("[_maybePauseForRetry] Shifting to PAUSED state to trigger retry mechanism."), this._shiftState(g.PAUSED), L("[_maybePauseForRetry] Calling resume() to restart upload loop for retries."), this.resume(), S.resolve());
  }
  ...
  _finalize() {
    ...
    const e = X(this._blockTransferDocument[T.LINKS], u.BLOCK_FINALIZE, w({ path: this._relPath, intermediates: this._createIntermediates, respondWith: C(this._respondWith) ? JSON.stringify(this._respondWith) : this._respondWith, repoMetaPatch: this._repoMetaPatch, nameConflictPolicy: this._nameConflictPolicy }));
    return this._blockTransferDocument[T.LINKS][u.BLOCK_TRANSFER] = this._uploadedBlocksURLs, this._service.invoke(v.POST, e, { [b.CONTENT_TYPE]: Sn }, JSON.stringify(w(this._blockTransferDocument)), { isStatusValid: k(), retryOptions: { pollHeader: "location", pollCodes: [202], timeoutAfter: 12e4 }, responseType: "arraybuffer" }).then(((s) => {
      if (s.statusCode === 200 || s.statusCode === 201) {
        ...
        if (this._relationType === u.PRIMARY) {
          if (this.finalizeResponse = r, this.createdAsset = w({ assetId: r.headers["asset-id"], repositoryId: r.headers["repository-id"], links: ar(r.headers.link), etag: r.headers.etag, md5: r.headers["content-md5"] }), r.response && this._respondWith) try {
...
function mo({ additionalHeaders: t, asset: e, componentId: s, contentType: r, dataOrSliceCallback: n, etag: o, maybeIsNew: i, md5: a, progressCb: d, relation: l, size: h, svc: p, blockSize: _, maxConcurrentRequests: f }) {
  Sc("_upload()"), E(["svc", p, "object"], ["asset", e, "object"], ["size", h, "number", !0], ["md5", a, "string", !0], ["etag", o, "string", !0]);
  const m = Je(n, h), y = Be(m), P = x(p);
  if (ur(e, y)) return Rt({ asset: e, additionalHeaders: t, componentId: s, contentType: r, dataOrSliceCallback: n, etag: o, md5: a, progressCb: d, relation: l, size: h, service: P, blockSize: _, maxConcurrentRequests: f });
  V(e.links, [l]);
  const I = X(e.links, l, { component_id: s });
  return S.resolve(void 0, { blockUpload: void 0, progress: d }).then((() => Promise.resolve(Y(n) ? n(0, y) : n))).then(((R) => Yt({ asset: e, additionalHeaders: t, contentType: r, data: R, etag: o, headHref: I, href: I, maybeIsNew: i, relation: l, service: P }))).then(((R) => {
    let D = {};
    try {
...
function yo({ service: t, asset: e, additionalHeaders: s, dataOrSliceCallback: r, contentType: n, progressCb: o, relation: i, size: a, componentId: d, md5: l, etag: h, relPath: p, createIntermediates: _, respondWith: f, blockSize: m, repoMetaPatch: y, maxConcurrentRequests: P, nameConflictPolicy: I }) {
  ...
  const D = pr(t, e || (function(O) {
    ...
    const N = x(O), M = qe(Ec, N);
    return Fe(M, {});
  })(t), w({ [j.REPO_REL_TYPE]: i, [j.REPO_IF_MATCH]: h, [j.REPO_SIZE]: a, [j.DC_FORMAT]: n, [j.COMPONENT_ID]: d, [j.REPO_MD5]: l, [j.REPO_BLOCK_SIZE]: m }), s);
  return D.then(((O) => {
    const N = new Nc(t, R, O.result, i, a, n, d, l, h, p, _, f, y, P, I);
...
function Rt({ service: t, asset: e, additionalHeaders: s, dataOrSliceCallback: r, contentType: n, progressCb: o, relation: i, size: a, componentId: d, md5: l, etag: h, relPath: p, createIntermediates: _, respondWith: f, blockSize: m, repoMetaPatch: y, maxConcurrentRequests: P, nameConflictPolicy: I }) {
  return yo({ service: t, asset: e, additionalHeaders: s, dataOrSliceCallback: r, contentType: n, progressCb: o, relation: i, size: a, componentId: d, md5: l, etag: h, relPath: p, createIntermediates: _, respondWith: f, blockSize: m, repoMetaPatch: y, maxConcurrentRequests: P, nameConflictPolicy: I });
}
function Rs({ service: t, additionalHeaders: e, dataOrSliceCallback: s, contentType: r, progressCb: n, relation: o, size: i, componentId: a, md5: d, etag: l, relPath: h, respondWith: p, blockSize: _, repoMetaPatch: f, maxConcurrentRequests: m, nameConflictPolicy: y }) {
  return yo({ service: t, asset: void 0, additionalHeaders: e, dataOrSliceCallback: s, contentType: r, progressCb: n, relation: o, size: i, componentId: a, md5: d, etag: l, relPath: h, createIntermediates: !0, respondWith: p, blockSize: _, repoMetaPatch: f, maxConcurrentRequests: m, nameConflictPolicy: y });
}
function Dc(t) {
...
function Mc(t, e, s, r, n = {}) {
  ...
  return t.invoke(v.PATCH, o, Object.assign(n, { [b.CONTENT_TYPE]: ht, [b.IF_MATCH]: r }), typeof s == "string" ? s : JSON.stringify(s), { isStatusValid: k(), retryOptions: { pollCodes: [202], pollHeader: "location", pollMethod: "GET" } });
}
...
function Uc(t, e, s, r = "defaultbuffer", n, o) {
  ...
  const i = n ? ni(e.links[u.RENDITION], n, s) : X(e.links, u.RENDITION, Object.assign({}, s));
...
function Qr(t, e, s, r, n, o, i, a, d) {
  ...
  const p = w({ reltype: n, component_id: o, revision: i }), _ = X(h.links, u.BLOCK_DOWNLOAD, { resource: n !== void 0 ? JSON.stringify(p) : void 0 });
...
function xc(t, e, s, r, n, o, i, a) {
  return _r("updatePrimaryResource()"), E(["service", t, "object"], ["asset", e, "object"], ["dataOrSliceCallback", s, ["function", "object", "string"]], ["contentType", r, "string"], ["size", n, "number", !0], ["md5", i, "string", !0]), V(e.links, [u.PRIMARY]), mo({ svc: t, asset: e, dataOrSliceCallback: s, contentType: r, relation: u.PRIMARY, size: n, md5: i, maybeIsNew: !1, etag: o, additionalHeaders: a }).catch(((d) => {
    var l;
    if (((l = d.response) === null || l === void 0 ? void 0 : l.statusCode) === 413) return Rt({ service: x(t), asset: e, dataOrSliceCallback: s, contentType: r, relation: u.PRIMARY, size: n, md5: i, etag: o, additionalHeaders: a });
    throw d;
  }));
}
...
class ds {
  ...
  getPage(e = {}, s) {
    ...
    const o = X(this._links, u.PAGE, n);
...
function jc(t, e, s, r, n) {
  ...
  const o = Object.assign(Object.assign({}, n), { [b.CONTENT_TYPE]: ht });
  r && (o[b.IF_MATCH] = r);
...
function Ro(t, e, s, r) {
  ...
  const n = X(e.links, u.PAGE, { version: s });
...
function Hc(t, e, s) {
  return _e("headCompositeManifest()"), E(["svc", t, "object"], ["asset", e, "object"]), V(e.links, [u.MANIFEST]), ls(t, e, void 0, s).then(((r) => t.invoke(v.HEAD, r, s, void 0, { responseType: "json", isStatusValid: k() })));
}
function $c(t, e, s, r, n) {
  return _e("getCompositeManifest()"), E(["svc", t, "object"], ["asset", e, "object"], ["version", s, "string", !0], ["etag", r, "string", !0]), V(e.links, [u.MANIFEST]), ls(t, e, s, n).then(((o) => t.invoke(v.GET, o, Object.assign(n ?? {}, r ? { [b.IF_NONE_MATCH]: r } : {}), void 0, { isStatusValid: k([304]), retryOptions: { pollCodes: [404, 202], pollHeader: "location", pollMethod: v.GET, problemWithCode: { problemType: J.RESOURCE_NOT_READY, code: 404 } } }))).then(((o) => {
...
function Gc(t, e, s, r) {
  return _e("_getComponentPathUrl()"), gr(t, e, u.COMPONENT, e.version, r).then(((n) => Fe(n, w({ component_path: s }))));
}
...
function Yc(t, e, s, r, n, o) {
  ...
  return r && i.push(u.PAGE), ut(t, e, i, void 0, o).then(((a) => ne(this, void 0, void 0, (function* () {
    ...
    const d = x(t), l = s.map((({ component_path: _, responseType: f, subrequestHeaders: m }) => ({ method: v.GET, href: X(e.links, u.COMPONENT, { component_path: _ }), headers: Object.assign(m || {}, o), component_path: _, responseType: f }))), h = yield ls(d, e, r, o);
    l.unshift({ method: v.GET, href: h, headers: Object.assign(n ? { [b.IF_NONE_MATCH]: n } : {}, o) });
    const p = { startTime: ae(), timeoutAfter: 72e5 };
    return gn(zc.bind(void 0, t, e, s, l, o), 404, p, J.RESOURCE_NOT_READY);
  }))));
}
function zc(t, e, s, r, n) {
  return ne(this, void 0, void 0, (function* () {
    ...
    return S.resolve(yield i.reduce(((a, d) => ne(this, void 0, void 0, (function* () {
      ...
      if (s.forEach(((y) => {
        ...
        return ne(this, void 0, void 0, (function* () {
          return (yield Promise.all(P.map(((N) => ne(this, void 0, void 0, (function* () {
            if (N.headers[b.CONTENT_TYPE] === Bs && N.response.type === J.RESPONSE_TOO_LARGE) {
              const M = en(N, y), Q = N.headers.location ? N.headers.location : X(R, u.BLOCK_DOWNLOAD, { resource: JSON.stringify({ component_path: M.component_path }) });
              if (O && O[M.component_path]) return { statusCode: 200, headers: w({ [b.CONTENT_TYPE]: N.headers["content-type"], [b.CONTENT_LENGTH]: N.headers["content-length"], [b.CONTENT_ID]: N.headers[b.CONTENT_ID] }), responseType: "application/json", response: { href: Q }, message: "OK" };
              const Z = yield et(x(I), Q, void 0, void 0, "defaultbuffer", !0, void 0, D);
              return Object.assign(Z.headers, { [b.CONTENT_ID]: N.headers[b.CONTENT_ID] }), Z;
            }
            return N;
          })))))).reduce(((N, M) => {
            const Q = en(M, y);
            try {
              const Z = it(M);
              N[Q.component_path] = Object.assign({}, Q, { response: M, [Z ? "error" : "data"]: Z || Os(M.response, Q.responseType || "defaultbuffer", M.headers["content-type"]) });
            } catch (Z) {
              N[Q.component_path] = Object.assign({}, Q, { response: M, error: new c(c.UNEXPECTED, "Error parsing sub-response into requested responseType", Z) });
            }
            return N;
          }), {});
        }));
      ...
      if (f.statusCode === 200) {
        p.manifest.data = Os(f.response, "json"), p.manifest.response = f, xs(e) && typeof ((l = e.current) === null || l === void 0 ? void 0 : l.parse) == "function" && (e.current.parse(ve(f.response)), e.current.versionId = f.headers.version), e.links = le(f);
        const y = oe(t);
        return y && y.setValueWithAsset(e.links, e), p;
      }
      if (f.statusCode === 304) return p.manifest.response = f, p;
      if (f.statusCode === 404) {
        if (f.response = Os(f.response, "json"), f.response && f.response.type === J.RESOURCE_NOT_READY) throw new c(c.NOT_FOUND, void 0, void 0, f);
        return p.manifest.error = it(f) || new c(c.NO_COMPOSITE, "Composite missing or deleted", void 0, f), p;
      }
      if (f.headers[b.CONTENT_TYPE] === Bs && f.response.type === J.RESPONSE_TOO_LARGE) {
        try {
          const y = f.headers.location ? f.headers.location : X(e.links, u.BLOCK_DOWNLOAD, { resource: JSON.stringify({ reltype: u.MANIFEST }) }), P = yield et(o, y, void 0, void 0, "json", !0, void 0, n);
          p.manifest.data = P.response, p.manifest.response = P, xs(e) && typeof ((h = e.current) === null || h === void 0 ? void 0 : h.parse) == "function" && e.current.parse(JSON.stringify(P.response)), e.links = le(P);
        } catch (y) {
...
function qc(t, e, s, r, n, o) {
  return ne(this, void 0, void 0, (function* () {
    ...
    if (e.deviceModifyDate && a.push({ op: "add", path: `/${[T.REPO_DEVICE_MODIFY_DATE]}`, value: e.deviceModifyDate }), a.length) {
      const _ = { [b.CONTENT_TYPE]: ht };
      i.push({ method: v.PATCH, href: H(e.links, u.REPO_METADATA), headers: _, body: JSON.stringify(a) });
    }
    const { result: d, response: l } = yield as(t, e, i, void 0, o, !0), { manifestResponse: h, repoMetadataResponse: p } = (function(_, f) {
...
function Ir(t, e, s, r) {
  return _e("getCompositeComponentUrl()"), E(["svc", t, "object"], ["asset", e, "object"], ["componentId", s, "string"], ["componentRevision", r, "string", !0]), V(e.links, [u.COMPONENT]), X(e.links, u.COMPONENT, { component_id: s, revision: r });
}
function Oo(t, e, s, r) {
  return _e("getPresignedUrl()"), E(["svc", t, "object"], ["asset", e, "object"]), ut(t, e, [u.BLOCK_DOWNLOAD], void 0, r).then(((n) => {
    const o = s ? JSON.stringify(s) : void 0, i = X(n, u.BLOCK_DOWNLOAD, { resource: o });
...
function Wc(t, e, s, r = "defaultbuffer", n, o) {
  return E(["svc", t, "object"], ["asset", e, "object"], ["componentPath", s, "string"], ["responseType", r, "string", !0], ["additionalHeaders", n, "object", !0]), ut(t, e, [u.COMPONENT, u.PAGE], void 0, n).then(((i) => {
    if (e.links = i, e.version) return Gc(x(t), e, s);
  })).then(((i) => dr(x(t), e, i ?? X(e.links, u.COMPONENT, { component_path: s }), u.COMPONENT, r, void 0, void 0, n, o)));
}
...
function Vs(t, e, s, r, n = 1, o, i = {}, a) {
  ...
  return V(e.links, [u.BULK_REQUEST, u.REPO_METADATA]), gr(t, e, u.MANIFEST, void 0, i).then(((d) => ne(this, void 0, void 0, (function* () {
    ...
    r ? l[b.IF_MATCH] = "*" : o && (l[b.IF_MATCH] = o);
    ...
    if (y) {
      const I = {}, R = w({ [T.REPO_DEVICE_MODIFY_DATE]: e.deviceModifyDate });
...
function Xc(t, e, s, r, n, o, i, a, d, l, h) {
  if (E(["service", t, "object"], ["asset", e, "object"], ["componentId", s, "string"], ["contentType", n, "string"], ["maybeIsNew", o, "boolean", !0], ["size", i, "number", !0], ["blockSize", h, "number", !0], ["md5", a, "string", !0]), o && !Xt(s)) throw new c(c.INVALID_PARAMS, "Component id is not a uuid");
  return Xt(s) || Fc.warn("Existing component id is not a uuid"), mo({ svc: t, asset: e, dataOrSliceCallback: r, contentType: n, relation: u.COMPONENT, size: i, componentId: s, md5: a, maybeIsNew: o, additionalHeaders: l, progressCb: d, blockSize: h }).then((({ response: p, result: _, isBlockUpload: f, asset: m }) => {
...
function Zc(t, e, s, r) {
  return ut(t, e, [u.COMPONENT, u.BLOCK_UPLOAD_INIT], void 0, r).then(((n) => {
    ...
    const a = Pt(w(Object.assign(Object.assign({}, r), { [b.AUTHORIZATION]: i.authProvider.authToken, [b.X_API_KEY]: i.authProvider.apiKey })));
    return Promise.all(s.map(((d) => ur(e, d.size) ? (function(l, h, p, _) {
      const f = w({ "repo:reltype": u.COMPONENT, "repo:size": p.size, "dc:format": p.contentType, component_id: p.componentId });
      return pr(l, h, f, _).then(((m) => {
        if (m.response.statusCode !== 200) throw new c(c.UNEXPECTED_RESPONSE, "Unexpected response from block upload init", m.response);
        const y = m.result;
        return { blockSize: y[j.REPO_BLOCK_SIZE], uploadRequestParameters: y[T.LINKS][u.BLOCK_TRANSFER].map((({ href: P }) => ({ href: P, method: v.PUT }))), finalizeRequestParameters: { href: X(y[T.LINKS], u.BLOCK_FINALIZE, {}), method: v.POST, headers: _, body: `${JSON.stringify(y)}` } };
      })).catch(((m) => {
        throw new c(c.UNEXPECTED_RESPONSE, "Unexpected response from block upload init", m);
      }));
    })(i, e, d, a) : (function(l, h, p, _) {
      return S.resolve({ blockSize: p.size, uploadRequestParameters: [{ href: Ir(l, h, p.componentId), method: v.PUT, headers: _ }] });
    })(i, e, d, a))));
  }));
}
...
class Tr extends bt {
  ...
  createAsset(e, s, r, n, o, i, a, d, l, h) {
    return Ps("createAsset()"), No(this._svc, this, e, s, r, n, o, i, a, d, l, h).then(((p) => ({ result: new bt(p.result, this.serviceConfig), response: p.response })));
  }
  createAssetForGuest(e, s, r, n, o, i, a, d, l) {
    return Ps("createAssetForGAT"), Do(this._svc, e, s, r, n, o, i, a, d, l).then(((h) => ({ result: new bt(h.result, this.serviceConfig), response: h.response })));
  }
  copy(e, s, r, n, o, i) {
...
function ct(t, e, s, r, n) {
  const o = x(t);
  return !n || n !== "rename" ? S.resolve(e.substring(e.lastIndexOf("/") + 1)) : C(s) && r && (r === u.REPO_METADATA || C(r) && r.reltype === u.REPO_METADATA) ? S.resolve(s.name || e.substring(e.lastIndexOf("/") + 1)) : Ic(o, { assetId: s.headers["asset-id"], links: le(s) }).then(((i) => i.result[T.REPO_NAME])).catch(((i) => {
    throw i.response ? it(i.response) : new c(i.code, i.message, i.underlyingError, i.response, i.additionalData);
  }));
}
const No = ns("AdobeDCX.createAsset", (function(t, e, s, r, n, o, i = {}, a, d, l, h, p) {
  kt("createAsset()"), E(["service", t, "object"], ["parentDir", e, "object"], ["relPath", s, "string"], ["createIntermediates", r, "boolean"], ["contentType", n, "string"], ["respondWith", o, ["string", "object"], !0], ["additionalHeaders", i, "object", !0], ["repoMetaPatch", l, "object", !0]), o || p !== "rename" || (o = u.REPO_METADATA);
  const _ = C(o) ? JSON.stringify(o) : o;
  return ut(t, e, [u.CREATE]).then(((f) => {
    const m = X(f, u.CREATE, { path: s, intermediates: r.toString(), respondWith: _, mode: "id", repoMetaPatch: l, nameConflictPolicy: p }), y = Object.assign({}, { [b.CONTENT_TYPE]: n }, i), P = x(t), I = a ? Je(a, d) : void 0, R = I ? Be(I) : 0;
    return a && ur(e, R) ? Rt({ service: P, contentType: n, relation: u.PRIMARY, asset: e, dataOrSliceCallback: a, size: R, relPath: s, createIntermediates: r, respondWith: o, repoMetaPatch: l, additionalHeaders: i, progressCb: h, nameConflictPolicy: p }).then((({ result: D, response: O }) => ct(t, s, O, o, p).then(((N) => ({ result: w(xe({ name: N }, D)), response: O }))))) : S.resolve().then((() => ne(this, void 0, void 0, (function* () {
      const D = Y(a) ? yield a(0, R) : I;
      return P.invoke(v.POST, m, y, D, { responseType: "json", isStatusValid: k([413]), reuseRequestDesc: { id: "createAsset", method: v.POST, href: m, headers: y, progress: h } }).then(((O) => {
        var N;
        if (O.statusCode === 413) return Rt({ service: P, contentType: n, relation: u.PRIMARY, asset: e, dataOrSliceCallback: a, size: Be(Je(a, d)), relPath: s, createIntermediates: r, respondWith: o, repoMetaPatch: l, additionalHeaders: i, progressCb: h, nameConflictPolicy: p }).catch(((re) => {
          var ge;
          if (re.problemType === J.ASSET_NAME_CONFLICT) {
            const Pe = { assetId: (ge = re.response.response) === null || ge === void 0 ? void 0 : ge["repo:assetId"], links: le(re.response) };
            return Rt({ service: P, contentType: n, relation: u.PRIMARY, asset: Pe, dataOrSliceCallback: a, size: Be(Je(a, d)), relPath: s, createIntermediates: r, respondWith: o, repoMetaPatch: l, additionalHeaders: i, progressCb: h, nameConflictPolicy: p });
          }
          throw re;
        })).then((({ result: re, response: ge }) => ct(t, s, ge, o, p).then(((Pe) => ({ result: w(xe({ name: Pe }, re)), response: ge })))));
        let M;
        e.path && (M = dn(e.path, s));
        const Q = le(O), Z = O.headers;
        if (!((N = Z[b.CONTENT_TYPE]) === null || N === void 0) && N.includes("multipart/mixed")) {
          const re = lr(O)[1];
          throw re.statusCode === 404 ? new c(c.ASSET_NOT_FOUND, "Asset was created successfully but repository metadata could not be found.", void 0, O) : re.statusCode === 403 ? new c(c.FORBIDDEN, "Asset was created successfully but Permission denied for fetching repository metadata.", void 0, O) : $s("Unexpected Server Response", void 0, O);
        }
        const he = C(O.response) ? O.response : { etag: "", md5: "" }, be = Z["asset-id"] || Z["x-resource-id"], Oe = e.repositoryId;
        pe("assetId", be);
        let z = he.etag, Me = he.md5;
        o == null && (z = Z.etag, Me = Z["content-md5"]);
        ...
        const wt = oe(t);
        return wt && wt.setValueWithAsset(Q, Ee), ct(t, s, O, o, p).then(((re) => ({ result: w(xe({ name: re }, Ee, w({ links: Q, assetId: be, etag: z, md5: Me, repositoryId: Oe, format: n, path: M }))), response: O })));
      }));
    }))));
  }));
}));
function Do(t, e, s, r, n = {}, o, i, a, d, l) {
  kt("createAssetForGuest()"), E(["service", t, "object"], ["relPath", e, "string"], ["contentType", s, "string"], ["respondWith", r, ["string", "object"], !0], ["additionalHeaders", n, "object", !0], ["repoMetaPatch", a, "object", !0]), r || l !== "rename" || (r = u.REPO_METADATA);
  ...
  return (function(_, f, m, y, P) {
    ...
    return o && y > cs ? Rs({ service: p, contentType: s, relation: u.PRIMARY, dataOrSliceCallback: o, size: y, relPath: e, respondWith: r, repoMetaPatch: a, additionalHeaders: n, progressCb: d, nameConflictPolicy: l }).then((({ result: P, response: I }) => ct(t, e, I, r, l).then(((R) => ({ result: w(xe({ name: R }, P)), response: I }))))) : S.resolve().then((() => ne(this, void 0, void 0, (function* () {
      ...
      return p.invoke(v.POST, _, f, P, { responseType: "json", isStatusValid: k([413]), reuseRequestDesc: { id: "createAssetForGuest", method: v.POST, href: _, headers: f, progress: d } }).then(((I) => {
        var R;
        if (I.statusCode === 413) return Rs({ service: p, contentType: s, relation: u.PRIMARY, dataOrSliceCallback: o, size: Be(Je(o, i)), relPath: e, respondWith: r, repoMetaPatch: a, additionalHeaders: n, progressCb: d, nameConflictPolicy: l }).catch(((z) => {
          if (z.problemType === J.ASSET_NAME_CONFLICT) return Rs({ service: p, contentType: s, relation: u.PRIMARY, dataOrSliceCallback: o, size: Be(Je(o, i)), relPath: e, respondWith: r, repoMetaPatch: a, additionalHeaders: n, progressCb: d, nameConflictPolicy: l });
          throw z;
        })).then((({ result: z, response: Me }) => ct(t, e, Me, r, l).then(((Ee) => ({ result: w(xe({ name: Ee }, z)), response: Me })))));
        const D = le(I), O = I.headers;
        if (!((R = O[b.CONTENT_TYPE]) === null || R === void 0) && R.includes("multipart/mixed")) {
          const z = lr(I)[1];
          throw z.statusCode === 404 ? new c(c.ASSET_NOT_FOUND, "Asset was created successfully but repository metadata could not be found.", void 0, I) : z.statusCode === 403 ? new c(c.FORBIDDEN, "Asset was created successfully but Permission denied for fetching repository metadata.", void 0, I) : $s("Unexpected Server Response", void 0, I);
        }
        const N = C(I.response) ? I.response : { etag: "", md5: "" }, M = O["asset-id"] || O["x-resource-id"], Q = O["repository-id"];
        let Z = N.etag, he = N.md5;
        r == null && (Z = O.etag, he = O["content-md5"]);
        const be = C(I.response) && r && (r === u.REPO_METADATA || C(r) && r.reltype === u.REPO_METADATA) ? se(I.response) : {}, Oe = oe(t);
        return Oe && Oe.setValueWithAsset(D, be), ct(t, e, I, r, l).then(((z) => ({ result: w(xe({ name: z }, be, w({ links: D, assetId: M, etag: Z, md5: he, format: s, repositoryId: Q, path: e }))), response: I })));
      }));
    }))));
  }));
}
const hs = B("dcx:assets:discoverable");
function Qc(t, e = {}, s) {
  hs("getDiscoverableAssets()"), E(["svc", t, "object"], ["pageOpts", e, "object"]);
  const r = x(t);
...
class ud {
  ...
  getComponentDescriptor(e) {
    ...
    return JSON.stringify((function(r, n, o, i) {
      ...
      const a = { versionId: dd, componentId: i.id, cloudAssetId: r, compositeId: n, repositoryId: o, componentRevisionId: i.version, type: i.type, cloudExpiration: void 0, size: i.length, etag: i.etag, hashType: ld, hashValue: i.md5 };
      return w(a);
...
function pd(t, e, s, r, n, o) {
  return E(["componentId", t, "string"], ["etag", e, "string"], ["version", s, "string"], ["md5", r, "string"], ["length", n, "number"], ["type", o, "string"]), new hd(t, e, s, r, n, o);
}
function _d(t, e, s) {
  ...
  if (r.assetId && r.repositoryId) i = S.resolve(rn(s, r.assetId, r.repositoryId));
    ...
    E(["session", t, "object"]);
    const a = r.links || n.links, d = Dn(a, [u.PRIMARY, u.ID, u.PATH, u.COMPONENT]), l = X(a, d, { component_id: "manifest" });
...
let Ge = class {
  ...
  set blockUploadThreshold(t) {
    ze("threshold", t, "+number"), this._blockUploadThreshold = t;
  }
  get blockDownloadThreshold() {
    return Ao();
  }
  set blockDownloadThreshold(t) {
    ze("threshold", t, "+number"), Pc(t);
  }
  ...
  resolveAsset(t, e = "id", s, r, n) {
    return hr(this.serviceConfig, t, e, s, r, n);
  }
  ...
  putEmbeddedMetadata(t, e, s, r = "json", n) {
    return E(["asset", t, "object"], ["data", e, ["string", "object", "object[]"]], ["etag", s, "string", !0], ["format", r, "enum", !1, ["json", "xml"]]), this.fetchLinksIfMissing(t, [u.EMBEDDED_METADATA], n).then((() => Lc(this._service, t, e, s, r, n)));
  }
  ...
  getACLPolicy(t, e) {
    return this.fetchLinksIfMissing(t, [u.ACL_POLICY], e).then((() => lo(this._service, t, e)));
  }
  ...
  checkACLPrivilege(t, e, s, r) {
    return this.fetchLinksIfMissing(t, [u.ACCESS_CHECK], r).then((() => ho(this._service, t, e, s, r)));
  }
  headAppMetadata(t, e) {
  ...
  getCompositeManifestUrl(t, e, s) {
    ...
    return r.version = e || r.version, this.fetchLinksIfMissing(r, [u.MANIFEST], s).then((() => ls(this._service, r, e, s)));
  }
  ...
  putCompositeComponent(t, e, s, r, n, o, i, a, d, l) {
    ...
    return (h.assetId || h.id) && pe("assetId", h.assetId || h.id), pe("componentId", e), o && pe("componentSize", String(o)), this.fetchLinksIfMissing(h, [u.COMPONENT, u.BLOCK_UPLOAD_INIT], d).then((() => Xc(this.serviceConfig, t, e, s, r, n, o, i, a, d, l)));
  }
  ...
  packageAssets(t, e, s, r, n) {
    return Gn(this.serviceConfig, t, e, s, r, n);
  }
  performOperation(t, e) {
    return Le(this.serviceConfig, e).then(((s) => Ve(this._service, s, t, e)));
  }
  performBatchOperation(t, e) {
    return Le(this.serviceConfig).then(((s) => Qa(this._service, s, t, e)));
  }
...
rt([It], Ge.prototype, "getRepoMetadata", null), rt([It], Ge.prototype, "getAppMetadata", null), rt([It], Ge.prototype, "getCompositeComponent", null), rt([It], Ge.prototype, "putCompositeComponent", null), rt([It], Ge.prototype, "moveAsset", null), Ge = rt([Ba("AdobeRepoAPISession")], Ge);
const Ed = (t, e, s) => new Ge(t, e, s), gd = {
...
const $e = B("dcx:http:backoff");
function vd(t, e, s, r = {}, n, o = {}, i = !1) {
  const { disableRetry: a = !1, retryNetworkError: d = !0, responseType: l = "text", authCallback: h = null, progressListeners: p = [], initialWait: _ = 2e3, maxWait: f = 32e3, preCallback: m, postCallback: y, preScheduleCallback: P, postScheduleCallback: I, preferRetryAfterHeader: R = !0, pollCodes: D = [], pollHeader: O, pollMethod: N = "get", problemWithCode: M = { problemType: "", code: null, url: "" }, modifyHeadersCallback: Q = null, skipPollingTimeout: Z = !1 } = o;
  let { retryCodes: he = [], timeoutAfter: be = 72e3 } = o;
  he = i ? [...D, ...he] : a || Yo(s) ? [] : o.retryCodes || pn, $e("retry codes", he);
  const Oe = o.increase || ((W, ee, U) => W === 1 ? U : ee * ee > f ? f : ee * ee);
  let z = 0, Me = 0, Ee = !1;
  const wt = ae();
  let re, ge, Pe, me, pt = ae(), We = 0, Lt = !1, ps = !1;
  const Ar = [];
  let mr;
  function Mt() {
    $e("getSnapshot()", Ee, z, ae(), pt, We);
    const W = Ee || re != null ? 0 : z - (ae() - pt);
    let ee = We;
    ee += Ee ? ae() - pt : 0;
    const U = (re || ae()) - wt;
    return { count: Me, canceled: Lt, timedOut: ps, requests: Ar, duration: U, totalWaited: ee, requestPending: Ee, waitingFor: W };
  }
  function yr() {
    const W = Oe(Me, z, _);
    return Math.min(W, f);
  ...
  function br(W) {
    ...
    if (R && ee) {
      if (isNaN(ee)) {
        ...
        return $e("nextWait from retry-after", U), U < 0 ? yr() : U;
      }
  ...
  function st(W = z) {
    return je(this, void 0, void 0, (function* () {
      if (We >= be) {
        if ($e("timed out", We, be), !ot(me.getStatus(), D)) return ps = !0, ge(me);
        if (!Z) return ps = !0, Pe(new c(c.TIMED_OUT, "DCX backoff timed out", void 0, me.getResponse()));
      }
      pt = ae(), P && (yield P(Mt())), $e("retry in ", W), mr = setTimeout((() => {
        var ee;
        try {
          $e("retry start"), Fr(`Request: ${e.toUpperCase()} ${t} ${(ee = r == null ? void 0 : r["x-request-id"]) !== null && ee !== void 0 ? ee : ""}`), Ee = !0, We += W, me = new yd(Object.assign(Object.assign({}, o), { timeout: n, preCallback: vr(m), postCallback: vr(y) })), Ar.push(me), Me++;
          for (const U of p) me.onProgress(U);
          me.send(t, e, s, r, l).then(((U) => je(this, void 0, void 0, (function* () {
            var _s, fs, Es;
            if (Fr(`Response: ${e.toUpperCase()} ${t} ${(_s = U.headers) === null || _s === void 0 ? void 0 : _s["x-request-id"]} ${U.getStatus()}`), Ee = !1, !U.isError() && !ot(U.getStatus(), he) && (U.getStatus() !== 401 || h == null) && (typeof O != "string" || D == null || !ot(U.getStatus(), D)) || (M == null ? void 0 : M.code) === U.getStatus() && U.getResponseData() && (M == null ? void 0 : M.problemType) !== ((fs = yield U.getResponseDataAsJSON()) === null || fs === void 0 ? void 0 : fs.type)) return re = ae(), ge(U);
            if (U.isAborted() || Lt) return re = ae(), Lt = !0, ge(U);
            if (!i && typeof O == "string" && D != null && ot(U.getStatus(), D)) {
              ...
              if (_t || Rr) {
                i = !0, t = Rr ? ft : _t, e = N, s = void 0, Q && (r = Q(r)), he = [...he, ...D], We = 0, be *= 20;
                const xo = U.getResponseHeader("retry-after");
                if (R && xo) {
                  const Or = br(U);
                  if (Or != null) return z = Or, st(z);
                }
                return st(0);
              }
            }
  ...
  return { getPromise: () => Uo, cancel: function() {
    $e("cancel()"), Lt = !0, me != null && me.abort(), Ee || ($e("abort"), clearTimeout(mr), ge({ getErrorCode: () => te.ABORTED }));
...
class bd {
  constructor(e, s, r, n, o = "text", i, a, d = {}) {
    ...
    delete d.descriptor;
    const { cancel: h, getPromise: p, onProgress: _, getSnapshot: f } = vd(e, s, r, n, d.timeout, Object.assign(Object.assign(Object.assign(Object.assign({}, d), { responseType: o, authCallback: a }), d.retryOptions), { descriptor: l, forceXhr: d.forceXhr, autoParseJson: d.autoParseJson }));
    this.onProgress = _, typeof i == "function" && _(((m, y) => i("progress", { total: y, sentOrReceived: m }))), this._cancel = h, this._promise = p(), this._getSnapshot = f;
  }
  getSnapshot() {
...
class us {
  constructor(e) {
    var s;
    if (this._pausable = !1, this._listeners = { progress: [], cancel: [] }, this._isStatusValid = e.isStatusValid || qt, this._isExternalRequest = e.isExternalRequest, this._authProvider = e.authProvider, this._id = e.id, this._descriptor = e.descriptor, e.descriptor && e.descriptor.progress) {
...
class Sd {
  ...
  invoke(e = "GET", s, r = {}, n, o = {}, i) {
    ...
    if (l != null && l !== "void" || (d = o.autoParseJson == null || o.autoParseJson, l = o.responseType = "text"), l === "defaultbuffer" && (l = Wt() ? o.responseType = "buffer" : o.responseType = "arraybuffer"), l === "buffer") {
      if (typeof Buffer != "function") throw new c(c.INVALID_PARAMS, "No Buffer class");
    } else if (l === "blob") {
      if (typeof Blob != "function") throw new c(c.INVALID_PARAMS, "No Blob class");
...
const Nd = (t, e) => new Sd(t, {}), Lo = class Mo extends CustomEvent {
  constructor(e) {
    super(Mo.EVENT_NAME, { bubbles: !0, composed: !0, detail: e });
  }
};
Lo.EVENT_NAME = md.UPLOAD_STATUS;
let Dd = Lo;
class kd {
  /**
  ...
  async initializeLogging() {
    const { LogService: e } = await import("./Logging-CvmJOUuN.min.js");
  ...
  async createAsset(e) {
    ...
    try {
      ...
      throw (o = this.logService) == null || o.log("Failed to create temporary guest asset", {
        documentPath: s,
  ...
  async getAssetVersion(e) {
    ...
    try {
      ...
      if (o.response.statusCode < 200 || o.response.statusCode >= 300) {
        ...
        throw (s = this.logService) == null || s.log("Failed to get asset versions", {
          assetId: e.assetId,
      ...
      return (r = this.logService) == null || r.log("Retrieved asset version", {
        assetId: e.assetId,
        version: i,
        totalVersions: o.result.versions.length
      }), i;
    } catch (o) {
      throw (n = this.logService) == null || n.log("Error getting asset versions", {
        assetId: e.assetId,
  ...
  async downloadAssetContent(e) {
    var s, r, n;
    (s = this.logService) == null || s.log("Downloading asset content", { assetId: e.assetId });
    try {
      const o = await this.session.blockDownloadAsset(e);
      this._validateDownloadResponse(o);
      const i = new Blob([o.response]);
      return this._validateDownloadedContent(i), (r = this.logService) == null || r.log("Asset content downloaded successfully", {
        assetId: e.assetId,
        blobSize: i.size
      }), i;
    } catch (o) {
      throw (n = this.logService) == null || n.log("Failed to download asset content", {
        assetId: e.assetId,
        error: o instanceof Error ? o.message : String(o)
      }), o;
    }
  ...
  */
  ...
  async deleteAsset(e) {
    ...
    try {
      ...
      (n = this.logService) == null || n.log("Failed to delete asset", {
        assetId: r,
        error: o instanceof Error ? o.message : String(o)
      });
    }
  ...
  */
  ...
  async initializeBlockUpload(e, s, r, n) {
    ...
    try {
      ...
      return (o = this.logService) == null || o.log("Block upload initialized successfully", {
        hasLinks: !!h._links
      }), h;
    } catch (a) {
      throw (i = this.logService) == null || i.log("Failed to initialize block upload:", a), a;
    }
  }
  /**
   * Finalize the upload
  ...
  async finalizeUpload(e) {
    var s, r, n;
    (s = this.logService) == null || s.log("Finalizing upload");
    try {
      const o = this.getLinkHref(e._links, u.BLOCK_FINALIZE);
      if (!o)
        throw new Error("Block finalize URL not found in upload asset links");
      const i = await this.httpService.invoke(
        "POST",
        o,
        { "Content-Type": this.TRANSFER_DOCUMENT },
        JSON.stringify(e)
      ...
      if (i.statusCode < 200 || i.statusCode >= 300)
        throw new Error(`Block upload finalization failed: ${i.statusCode} ${i.message}. ${i.response}`);
      (r = this.logService) == null || r.log("Upload finalized successfully");
    } catch (o) {
      throw (n = this.logService) == null || n.log("Failed to finalize upload:", o), o;
    }
  }
}
const Ud = async (t) => {
...
//# sourceMappingURL=index-C62mOUVW.min.js.map
