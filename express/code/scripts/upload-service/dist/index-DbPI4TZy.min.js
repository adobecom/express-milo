...
const pd = (t, e, s) => new Ge(t, e, s), _d = "https://platform-cs-stage.adobe.io", fd = "AdobeExpressWeb", Ed = "temp", gd = "Failed to upload asset. Please try again.", Fe = {
  UPLOAD_FAILED: {
    code: "UPLOAD_FAILED",
    message: gd
  },
...
class Cd {
  ...
  async initializeLogging() {
    const { LogService: e } = await import("./Logging-CcSaImGO.min.js");
    ...
    try {
      ...
      switch (this.authConfig.tokenType) {
        case "guest": {
          ...
          const f = await this.generatePreSignedUrl({ asset: l.result });
          console.log("preSignedUrl", f);
          break;
        }
        case "user":
        default: {
...
//# sourceMappingURL=index-DbPI4TZy.min.js.map
