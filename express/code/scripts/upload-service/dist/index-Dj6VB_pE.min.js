...
}, fd = "AdobeExpressWeb", Ed = "assets", gd = "Upload failed. Please try again.", Fe = {
  UPLOAD_FAILED: {
    code: "UPLOAD_FAILED",
    message: gd
  },
...
class Cd {
  ...
  async initializeLogging() {
    const { LogService: e } = await import("./Logging-CoIJWvXW.min.js");
  ...
  handleError(e, s, r) {
    ...
    const o = r || n.message;
    return this.config.environment === "local" || this.config.environment === "stage" ? (window == null || window.lana.log(`UploadService Error [${n.code}]: ${o}`), window == null || window.lana.log(s)) : n = Fe.UPLOAD_FAILED, new class extends Error {
      constructor(a, d, h) {
...
//# sourceMappingURL=index-Dj6VB_pE.min.js.map
