export default class GenAICards {
  constructor(page) {
    ...
    this.galleryControl = this.cardsSection.locator('.gallery-control');
    this.prevButton = this.galleryControl.locator('button').first();
    this.nextButton = this.galleryControl.locator('button').last();
